// 原始作者: SunnyDesignor
// 来源: https://github.com/SunnyDesignor/WpfGorgeousThemeSwitch
// 许可证: MIT
...
namespace MCBS.WpfApp.AttachedProperties
{
    ...
    {
        private const string MouseLeaveChecked = nameof(MouseLeaveChecked);
        private const string MouseLeaveUnChecked = nameof(MouseLeaveUnChecked);
